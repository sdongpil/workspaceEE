...
public class DispatcherServlet extends HttpServlet {
	...
	private void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		/*
		 * 1.DispatcherServlet 이 클라이언트의 요청url 사용해서 요청분석
		 */
		...
		/*
		 * 2.DispatcherServlet 이 클라이언트 요청에 따른 비즈니스 실행[service객체사용]
		 */
		String forwardPath = "";
		...
		/*
		 * 3.DispatcherServlet이 forwardPath를 사용해서 forward혹은 redirect를 한다.
		 */
